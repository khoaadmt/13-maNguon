...
* @throws Exception
*/
public void LuuFile(String fileName, ArrayList<DeThi> ds) 
        throws Exception{
    //Tạo luồng ghi file
...
public ArrayList<DeThi> DocFile(String fileName) throws Exception{
    ArrayList<DeThi> ds =new ArrayList<>();
    ...
    DeThi obj = null;
    while ((obj = (DeThi) ois.readObject()) != null ) {
        ds.add(obj);
    }
    //đóng luồng
    fi.close();
